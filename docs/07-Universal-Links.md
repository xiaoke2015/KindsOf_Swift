...
```
curl -v https://app-site-association.cdn-apple.com/a/v1/YourDomain

curl -v https://app-site-association.cdn-apple.com/a/v1/xfy.zxzx119.com

curl -v https://app-site-association.cdn-apple.com/a/v1/m.zxzx119.com
```
